...
export default function IssueAnalysis({ data }) {
  ...
  return (
    <div className="page">
      {/* KPI Row — matches PBI: KB Gaps, System Errors, Masked Data, Copilot Loops, Total Issues, Context Drops */}
      ...
      {/* Row 1: Total Issue Trend (line) | Issues by Type (pie) */}
      <div className="chart-row">
        <ChartCard title="Total Issue Trend" minHeight={300}>
          <ResponsiveContainer width="100%" height={260}>
            <LineChart data={c.issuesByMonth} margin={{ top: 5, right: 20, left: 0, bottom: 5 }}>
