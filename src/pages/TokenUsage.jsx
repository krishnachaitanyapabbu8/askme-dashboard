        ...
        <ChartCard title="Total Tokens by Month" minHeight={300}>
          <ResponsiveContainer width="100%" height={260}>
            <AreaChart data={c.tokensByMonth} margin={{ top: 5, right: 20, left: 30, bottom: 5 }}>
              ...
              <Area
                type="monotone" dataKey="totalTokens" name="Total Tokens"
        ...
        <ChartCard title="Prompt vs Completion Tokens by Month" minHeight={300}>
          <ResponsiveContainer width="100%" height={260}>
            <AreaChart data={c.tokenSplitByMonth} margin={{ top: 5, right: 20, left: 30, bottom: 5 }}>
              ...
              <Area
                type="monotone" dataKey="promptTokens" name="Prompt Tokens"
                stroke="#4472C4" strokeWidth={2} fill="url(#gradPrompt)" dot={{ r: 3 }}
              />
              <Area
                type="monotone" dataKey="completionTokens" name="Completion Tokens"
      ...
      <div className="chart-row">
        <ChartCard title="Total Tokens by ERP Module" scrollable minHeight={320}>
          <ResponsiveContainer width="100%" height={Math.max(280, c.tokensByModule.length * 36)}>
            <BarChart
              layout="vertical" data={c.tokensByModule}
        ...
        <ChartCard title="Avg Tokens by LLM Step" scrollable minHeight={320}>
          <ResponsiveContainer width="100%" height={Math.max(280, c.tokensByStep.length * 36)}>
            <BarChart
              layout="vertical" data={c.tokensByStep}
              margin={{ top: 5, right: 30, left: 20, bottom: 25 }}
            >
              <CartesianGrid strokeDasharray="3 3" stroke="#E0E0E0" horizontal={false} />
